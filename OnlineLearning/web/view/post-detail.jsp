                ...
                <jsp:include page="./base-view/dropDownAdmin.jsp"></jsp:include>
                    ...
                    <div class="container">
                        ...
                        <div class="container-table post">
                            <form action="../management/post-detail?bid=${bid}" method="post" class="form-submit">
                            <h4>Title</h4>
                            ...
                            <div class="property-display">
                                ...
                                <h4>Link IMG post</h4>
                                <input type="text" name="thumbnailUrl" class="title-post" id="" value="${Post.thumbnailUrl}" required>
                            <h4>Description</h4>

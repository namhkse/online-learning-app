                ...
                <div class="col-sm-10 p-0">
                    ...
                    <div class="container">
                        ...
                        <div class="container-table">
                            ...
                            <form id="form2nd" onsubmit="return checkSelectCategory()" action="../management/subject-add" method="post" class="form-submit" enctype="multipart/form-data">
                                <div class="form-content">
                                    <div class="left-part">
                                        <h4 class="title">Subject Name</h4>
                                        <input type="text" name="name" maxlength="200" class="input-box form-control" required>
                                        ...
                                        <textarea name="description" maxlength="2000" class="input-box form-control" rows="5" cols="50" required></textarea>
                                        <h4 class="title">Video Introduce</h4>
                                        <input type="text" name="video" maxlength="500" class="input-box form-control" required>

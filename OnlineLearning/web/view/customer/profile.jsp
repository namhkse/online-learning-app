...
<html lang="en">
    ...
    <body>
        ...
        <div id="container">
            <form action="profile" method="POST" onsubmit="return submitForm()">
                ...
                <div>
                    <table>                   
                        ...
                        <tr>
                            <td>Password</td>
                            <td><a href="change-password" style="color: #007bff">Change password</a></td>
                        </tr>
                        <tr><td></td></tr>
                        ...
                        <tr>
                            <td>Avatar url</td>
                            <td><input type="text" name="profilePictureUrl" value="${account.profilePictureUrl}" /></td>
                        </tr>
            ...
            <div id="avatar">
                <img src="${account.profilePictureUrl}" alt="Girl in a jacket" width="250" height="250">
            </div>  
        </div>
